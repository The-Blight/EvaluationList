...
Библиотека спроектирована в соответствии с принципами **Domain-Driven Design (DDD)** и **Clean Architecture**, обеспечивая строгую инкапсуляцию бизнес-правил, независимость от базы данных и высокую тестируемость.
